...
if menu == "Home":
    ...
    st.title("Klasifikasi Citra Dengan Metode CNN")
    st.write("Halaman ini akan berisi implementasi klasifikasi citra dengan model CNN.")
    st.write("Menunggu implementasi...")
