...
def home():
    ...
    st.write("""Aplikasi ini dirancang untuk memprediksi curah hujan berdasarkan data cuaca dan analisis citra awan. Berbagai metode seperti ARIMA, CNN, Decision Trees, dan K-Means digunakan untuk mendukung analisis ini. Tujuannya adalah untuk membantu sektor pertanian dan masyarakat dalam memahami pola cuaca yang lebih baik.""")
...
if menu == "Home":
    ...
    1. *Cluster 0:* Berhubungan dengan daerah dengan curah hujan tinggi.
    2. *Cluster 1:* Berhubungan dengan daerah dengan curah hujan sedang.
    3. *Cluster 2:* Berhubungan dengan daerah dengan curah hujan rendah.
    """)
    st.write(df)

    # Menampilkan peta
    st.subheader("Peta Heatmap Curah Hujan")
    st_folium(create_heatmap(df), width=700, height=500)
