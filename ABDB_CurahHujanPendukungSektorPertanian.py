...
if menu == "Home":
    ...
    2. *Cluster 2 (Curah Hujan Sedang - Cuaca Normal):*
       - Daerah dengan curah hujan sedang. Pada cluster ini, intensitas hujan masih cukup stabil dan normal. Bisa ditemukan pada daerah dengan iklim sedang.
    3. *Cluster 1 (Curah Hujan Rendah - Musim Kering):*
       - Wilayah dengan intensitas curah hujan rendah, biasanya daerah ini mengalami kekeringan dan bisa menjadi area yang memiliki tantangan dalam mengelola sumber daya air.
    """)
    st.subheader("Peta Heatmap Curah Hujan per Cluster")
    map_cluster = create_heatmap(df)
    st_folium(map_cluster, width=725, height=500)
